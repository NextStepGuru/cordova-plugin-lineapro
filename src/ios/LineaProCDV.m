...
{
    bool isKioskMode = [command.arguments[0] isEqualToString:@"1"] ? true : false;
    NSError* err;
...
{
    bool isCharging = [command.arguments[0] isEqualToString:@"1"] ? true : false;
    NSError* err;
...
{
    bool isPassThroughSync = [command.arguments[0] isEqualToString:@"1"] ? true : false;
    NSError* err;
